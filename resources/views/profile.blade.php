<!DOCTYPE html>
<!-- saved from url=(0031)https://trade-mate.io/w/profile -->
<html class="theme-init dark">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <link rel="shortcut icon" type="image/png" href="https://trade-mate.io/static/images/favicon.png">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <meta name="google-signin-client_id"
          content="454699158024-5i1h4fj9rvebvt3ibdb007a3f1nsqo9r.apps.googleusercontent.com">
    <meta name="verification" content="fb1fcfbd2e54fca7b21e57014fa67f">


    <title>trade-mate.io | Trading System</title>
...
<div>
    ...
    <div data-v-02e23f2e="" class="content"><!----> <!---->


        <div data-v-02e23f2e="" class="container">
            <div data-v-7d171b2a="" data-v-02e23f2e="" class="main profile ">
                    ...
                    <div data-v-7d171b2a="" class="row">
                            ...
                            <div data-v-7d171b2a="" class="block">
                                <div data-v-7d171b2a="">
                                    <div data-v-7d171b2a="" class="entity-nav entity-nav-bottom-line"><span
                                                data-v-7d171b2a=""
                                                class="entity-nav-title">Рабочие биржевые аккаунты</span>
                                    </div>
                                    <div data-v-7d171b2a=""
                        ...
                        <div data-v-7d171b2a="" class="col-md-12 col-xl-6">
                            <div data-v-7d171b2a="" class="block">
                                <form data-v-7d171b2a="">
                                    <div data-v-7d171b2a="" class="entity-nav entity-nav-bottom-line"><span
                                                data-v-7d171b2a=""
                                                class="entity-nav-title">Настройки пользователя</span>
                                    </div>
                                        ...
                                        <div data-v-7d171b2a="" class="row">
                                            <div data-v-7d171b2a="" class="col-md-12 col-xl-6">
                                                <div data-v-7d171b2a="" class="form-group"><label
                                                    ...
                                                    <input data-v-7d171b2a="" type="text"
                                                           class="form-control custom-input"></div>
                                                <div data-v-7d171b2a="" class="form-group"><label
                                                            data-v-7d171b2a="">Электронная почта</label>
                                                    <input data-v-7d171b2a="" disabled="disabled"
                            ...
                            <div data-v-7d171b2a="" class="block">
                                <form>
                                    <div class="entity-nav entity-nav-bottom-line"><span
                                    ...
                                    <div class="block-inner block-inner-buttons">
                            ...
                            <div class="block no-margin">
                                <div class="entity-nav entity-nav-bottom-line"><span
                                            class="entity-nav-title">Сессии</span> <span
                                            class="entity-nav-right-buttons"><button
                                                type="button"
                            ...
                            <div class="sort-panel">
                                ...
                                <div class="each-sort">Браузер</div>
                                <div class="each-sort">Ip</div>
                                <div class="each-sort">Первый вход</div>
                                <div class="each-sort">Посл. вход</div>
                            </div>
                            <div class="block">
                                <div
                                    ...
                                    <div data-v-7d171b2a="" class="sessions-list">
                                        <div data-v-7d171b2a="" class="each-session">
                                            ...
                                            <div data-v-7d171b2a="" class="session-cell f1"><img
                                                        ...
                                                        data-v-7d171b2a="">79.0.3945.88</span></div>
                                            <div data-v-7d171b2a="" class="session-cell f1">46.148.186.145
                                            </div>
                        ...
                        <div data-v-7d171b2a="" class="col-md-12 col-xl-6">
                            ...
                            <div data-v-7d171b2a="" class="block desktop">
                                ...
                                <form method="get">
                                    <div id="user-exchanges-form-container"
                                         class="block-inner">
                                        <div class="row">
                                            <div class="col-md-12 col-xl-6">
                                                <div class="form-group"><label
                                                    >Биржа</label>
                                                    <div class="use-mini-multiselect">
                                                        <div tabindex="0"
                                                             class="multiselect tasks-custom-multiselect multiselect-36 add-new-user-exchange">
                                                                        <span
                                                                                class="multiselect__caret"><span
        ...
        <div data-v-02e23f2e="" class="mobile-footer"><!----> <!----> <!----> <!---->
            <div data-v-02e23f2e="" class="router-link-default">
                <div data-v-02e23f2e="" class="mobile-footer-item menu-disabled">
                    <div data-v-02e23f2e="" class="ifont icon-four-squares-with-frame-shape"></div>
                    <div data-v-02e23f2e="" class="menu-item-text">Дашборд</div>
                </div>
            </div>
            <div data-v-02e23f2e="" class="router-link-default">
                <div data-v-02e23f2e="" class="mobile-footer-item menu-disabled">
                    <div data-v-02e23f2e="" class="ifont icon-coins"></div>
                    <div data-v-02e23f2e="" class="menu-item-text">Трейд</div>
                </div>
            </div>
            <div data-v-02e23f2e="" class="router-link-default">
                <div data-v-02e23f2e="" class="mobile-footer-item menu-disabled">
                    <div data-v-02e23f2e="" class="ifont icon-wifi-signal-waves"></div>
                    <div data-v-02e23f2e="" class="menu-item-text">Авто Тр.</div>
                </div>
            </div>
            <div data-v-02e23f2e="" class="router-link-default">
                <div data-v-02e23f2e="" class="mobile-footer-item menu-disabled">
                    <div data-v-02e23f2e="" class="ifont icon-arrowhead"></div>
                    <div data-v-02e23f2e="" class="menu-item-text">Кабинет</div>
                </div>
            </div>
            <a data-v-02e23f2e="" href="https://trade-mate.io/w/tasks"
               class="router-link-default tasks-link">
                <div data-v-02e23f2e="" class="mobile-footer-item">
                    <div data-v-02e23f2e="" class="ifont icon-circular-chart"></div>
                    <div data-v-02e23f2e="" class="menu-item-text">Статистика</div>
                </div>
            </a></div>
    </div>
...
<iframe name="ym-native-frame" title="ym-native-frame" frameborder="0" aria-hidden="true"
        ...
        src="./trade/saved_resource.html"></iframe>
